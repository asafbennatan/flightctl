...
func (t *DeviceRenderLogic) lookupOSDeltaGeneration(ctx context.Context, key deltastore.GenerationKey) (*deltamodel.DeltaGeneration, error) {
	statusOption := deltastore.WithStatus(deltamodel.DeltaGenerationSucceeded)
...
func cacheGenerationMemo(ctx context.Context, kv kvstore.KVStore, key deltastore.GenerationKey, ref string, memo generationMemo, log logrus.FieldLogger) {
