...
type ServerInterface interface {
	...
	ReadImageBuild(w http.ResponseWriter, r *http.Request, name string)
...
// (GET /api/v1/imagebuilds/{name})
func (_ Unimplemented) ReadImageBuild(w http.ResponseWriter, r *http.Request, name string) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// ReadImageBuild operation middleware
func (siw *ServerInterfaceWrapper) ReadImageBuild(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ReadImageBuild(w, r, name)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/api/v1/imagebuilds/{name}", wrapper.ReadImageBuild)
	})
	r.Group(func(r chi.Router) {
