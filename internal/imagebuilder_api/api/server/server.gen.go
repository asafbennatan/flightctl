...
func (siw *ServerInterfaceWrapper) ListImageBuilds(w http.ResponseWriter, r *http.Request) {
	...
	err = BindQueryParameter("withExports", r.URL.Query(), &params.WithExports, ParameterOptions{Style: "form", ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "boolean", Format: "", AllowReserved: false})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetImageBuildLog(w http.ResponseWriter, r *http.Request) {
	...
	err = BindQueryParameter("follow", r.URL.Query(), &params.Follow, ParameterOptions{Style: "form", ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "boolean", Format: "", AllowReserved: false})
	if err != nil {
