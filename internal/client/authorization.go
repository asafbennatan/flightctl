...
func CreateAuthProviderWithCredentials(authInfo AuthInfo, insecure bool, apiServerURL string, callbackPort int, username, password string, clientId, clientSecret string, web bool) (login.AuthProvider, error) {
	...
	case string(api.Oidc):
		...
		return login.NewOIDCConfig(provider.Metadata, oidcSpec, caFile, authInsecure, apiServerURL, callbackPort, username, password, clientId, clientSecret, web), nil
	...
	case string(api.Oauth2):
		...
		return login.NewOAuth2Config(provider.Metadata, oauth2Spec, caFile, authInsecure, apiServerURL, callbackPort, username, password, clientId, clientSecret, web), nil
	...
	case string(api.Openshift):
		...
		return login.NewOpenShiftConfig(provider.Metadata, openshiftSpec, caFile, authInsecure, apiServerURL, callbackPort, username, password, clientId, clientSecret, web), nil
	...
	case string(api.Aap):
		...
		return login.NewAAPOAuth2Config(provider.Metadata, aapSpec, caFile, authInsecure, apiServerURL, callbackPort, username, password, clientId, clientSecret, web), nil
