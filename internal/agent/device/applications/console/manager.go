...
// provides its own implementation. Manager knows nothing about the specific
// mechanism — it only calls Run.
...
// Defined here so this package does not need to import the applications package.
