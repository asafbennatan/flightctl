...
type createImageBuildJSONRequestBody = apiimagebuilder.ImageBuild

type createImageExportJSONRequestBody = apiimagebuilder.ImageExport
...
type ClientInterface interface {
	// ListImageBuilds makes a GET request to /api/v1/imagebuilds
	ListImageBuilds(ctx context.Context, params *ListImageBuildsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
	// CreateImageBuildWithBody makes a POST request to /api/v1/imagebuilds
	...
	// ListImageExports makes a GET request to /api/v1/imageexports
	ListImageExports(ctx context.Context, params *ListImageExportsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
	// CreateImageExportWithBody makes a POST request to /api/v1/imageexports
...
type ListImageBuildsParams struct {
	...
	// withExports (optional)
	WithExports *bool `form:"withExports" json:"withExports"`
}
...
// CreateImageBuild makes a POST request to /api/v1/imagebuilds with application/json body
...
// CreateImageExport makes a POST request to /api/v1/imageexports with application/json body
...
// NewListImageBuildsRequest creates a GET request for /api/v1/imagebuilds
func NewListImageBuildsRequest(server string, params *ListImageBuildsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.WithExports != nil {
			if queryFrag, err := StyleParameter("withExports", *params.WithExports, ParameterOptions{Style: "form", ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "boolean", Format: "", AllowReserved: false}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
// NewCreateImageBuildRequest creates a POST request for /api/v1/imagebuilds with application/json body
...
// NewCreateImageBuildRequestWithBody creates a POST request for /api/v1/imagebuilds with any body
...
// NewDeleteImageBuildRequest creates a DELETE request for /api/v1/imagebuilds/{name}
...
// NewGetImageBuildRequest creates a GET request for /api/v1/imagebuilds/{name}
...
// NewCancelImageBuildRequest creates a POST request for /api/v1/imagebuilds/{name}/cancel
...
// NewGetImageBuildLogRequest creates a GET request for /api/v1/imagebuilds/{name}/log
func NewGetImageBuildLogRequest(server string, name string, params *GetImageBuildLogParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.Follow != nil {
			if queryFrag, err := StyleParameter("follow", *params.Follow, ParameterOptions{Style: "form", ParamLocation: ParamLocationQuery, Explode: true, Required: false, Type: "boolean", Format: "", AllowReserved: false}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
// NewListImageExportsRequest creates a GET request for /api/v1/imageexports
...
// NewCreateImageExportRequest creates a POST request for /api/v1/imageexports with application/json body
...
// NewCreateImageExportRequestWithBody creates a POST request for /api/v1/imageexports with any body
...
// NewDeleteImageExportRequest creates a DELETE request for /api/v1/imageexports/{name}
...
// NewGetImageExportRequest creates a GET request for /api/v1/imageexports/{name}
...
// NewCancelImageExportRequest creates a POST request for /api/v1/imageexports/{name}/cancel
...
// NewDownloadImageExportRequest creates a GET request for /api/v1/imageexports/{name}/download
...
// NewGetImageExportLogRequest creates a GET request for /api/v1/imageexports/{name}/log
