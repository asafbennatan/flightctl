...
//go:generate go run -modfile=../../../tools/go.mod github.com/oapi-codegen/oapi-codegen-exp/cmd/oapi-codegen --config=server.gen.yaml ../../../api/core/v1beta1/openapi.yaml
