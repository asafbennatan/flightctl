...
// LinuxIssuerAuth represents an OIDC issuer that uses Linux PAM for authentication
...
func Load(cfgFile string) (*Config, error) {
	...
	if c.Auth != nil {
		...
		} else if c.Auth.OIDCIssuer.PAMService == "" {
			c.Auth.OIDCIssuer.PAMService = "flightctl"
		}
