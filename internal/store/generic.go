...
type Model interface {
	model.CertificateSigningRequest | model.Device | model.EnrollmentRequest | model.Fleet | model.OIDCProvider | model.Repository | model.ResourceSync | model.TemplateVersion | model.Event
}
