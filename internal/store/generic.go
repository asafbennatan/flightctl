...
type Model interface {
	model.AuthProvider | model.CertificateSigningRequest | model.Device | model.EnrollmentRequest | model.Fleet | model.ImageBuild | model.Repository | model.ResourceSync | model.TemplateVersion | model.Event
}
