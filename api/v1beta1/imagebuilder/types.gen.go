...
// ImageExportFormat ImageExportFormat specifies a format to export the image to.
type ImageExportFormat struct {
...
// ImageExportFormatStatus ImageExportFormatStatus represents the status of a single format export.
type ImageExportFormatStatus struct {
	// CompletedAt The time this format conversion completed.
	CompletedAt *time.Time `json:"completedAt,omitempty"`

	// Error Error message if this format conversion failed.
	Error *string `json:"error,omitempty"`
	...
	// Phase The phase of a single format conversion.
	Phase *ImageExportFormatPhase `json:"phase,omitempty"`

	// StartedAt The time this format conversion started.
	StartedAt *time.Time `json:"startedAt,omitempty"`
}
...
type ImageExportSpec struct {
	...
	// Formats The list of formats to export the image to.
	Formats []ImageExportFormat `json:"formats"`
...
type ImageExportStatus struct {
	...
	// Formats Per-format status tracking.
	Formats *[]ImageExportFormatStatus `json:"formats,omitempty"`
