...
| global.auth.sssdOidcIssuer.clientId | string | `"flightctl-client"` | OAuth2 client ID for the OIDC issuer |
| global.auth.sssdOidcIssuer.clientSecret | string | `""` | OAuth2 client secret for the OIDC issuer |
| global.auth.sssdOidcIssuer.issuer | string | `""` | The base URL for the OIDC issuer (defaults to API server URL) |
